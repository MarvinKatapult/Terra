#############################################################################
# Makefile for building: terra
# Generated by qmake (3.1) (Qt 5.15.12)
# Project:  terra.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile terra.pro
#############################################################################
...
COMPRESS      = gzip -9f
DISTNAME      = terra1.0.0
DISTDIR = /home/ibma/cpp/terra/debug/terra1.0.0
LINK          = g++
...
Makefile: terra.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
